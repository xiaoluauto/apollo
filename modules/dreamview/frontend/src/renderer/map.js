...
const parallelRoutingPoint = {
  x: 437885.43800078321,
  y: 4433042.4763044426,
};
const verticalRoutingPoint = {
  x: 437867.11691177945,
  y: 4433041.8646808155,
};
export default class Map {
  ...
  calcParkingSpaceExtraInfo(parkingSpace, coordinates) {
    ...
    routingPoint = type ? parallelRoutingPoint : verticalRoutingPoint;
    return {
      order: result,
      type,
      laneWidth,
